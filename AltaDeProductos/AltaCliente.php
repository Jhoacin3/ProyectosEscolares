<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-item nav-link" href="cliente.html">Cliente</a>
  ...
  $Tipocliente=$_POST['selectTipo de cliente'];
  $limitecredito=$_POST['inputLimite de credito'];
  ...
  echo "Limite de credito".$limitecredito."<br>";
  echo "Su direccion:".$Direccion."<br>";
  echo "Su Email:".$Email."<br>";
  
  $conexion=
  mysqli_connect("localhost","root","", "practica1")
  or die("Error al conectar a la BD");
  $consulta="INSERT INTO clientess VALUE
  ('$RFC','$Nombre','$Contacto','$Tipocliente','$limitecredito','$Direccion','$Email')";
