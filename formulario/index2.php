...
<body>
    <head>
        ...
        <nav>
            <image class="logo" src="img/logo1.png"></image>
            <h1 class="h1">Empresa de Iluminación</h1>
        </nav>
    </head>
    <style>
        nav{
...
<div class="container">
    ...
    <h4>Resultado</h4>
        ...
        <input class="bottons" type="submit" value="Actualizar" onclick= "document.location.reload();" >
        <input class="bottons" type="submit" value="Almacenar" name="almacenar">
    <?php
